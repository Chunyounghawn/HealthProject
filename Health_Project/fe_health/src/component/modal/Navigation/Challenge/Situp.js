          ...
          <PushUpBg>
            <PushUpBg2>
              ...
              <Mission2>
                ...
                <MissionFailBtn1 color={FailColor2} onClick={FailChoice2}>
                  실패
                </MissionFailBtn1>
              </Mission2>
              <Mission3>
                ...
                <MissionFailBtn1 color={FailColor3} onClick={FailChoice3}>
                  실패
                </MissionFailBtn1>
              </Mission3>
              <Mission4>
                ...
                <MissionFailBtn1 color={FailColor4} onClick={FailChoice4}>
                  실패
                </MissionFailBtn1>
              </Mission4>
            </PushUpBg2>
