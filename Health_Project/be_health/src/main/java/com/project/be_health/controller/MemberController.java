...
//    public String joinProc(@Valid MemberRequestDto dto, Errors errors, Model model) {
//        if (errors.hasErrors()) {
...
//    /* 회원정보 수정
//    @GetMapping("/modify")
//    public String modify(@LoginUser MemberRequestDto memberRequestDto, Model model) {
